...
class CalculatorAppElement extends HTMLElement {
    constructor() {
        super();
        const key = 'point-calculator-model-'+(this.getAttribute('id' || ''));
...
customElements.define('calculator-app', CalculatorAppElement);
